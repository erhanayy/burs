    ...
    return {
                ...
                $("#site_statistics").bind("plothover", function(event, pos, item) {
                    ...
                    if (item) {
                        if (previousPoint != item.dataIndex) {
                            ...
                            showChartTooltip(item.pageX, item.pageY, item.datapoint[0], item.datapoint[1] + ' bakim');
                        }
                    } else {
                        $("#tooltip").remove();
                        previousPoint = null;
                ...
                $("#site_activities").bind("plothover", function(event, pos, item) {
                    ...
                    if (item) {
                        if (previousPoint2 != item.dataIndex) {
                            ...
                            var x = item.datapoint[0].toFixed(2),
                                y = item.datapoint[1].toFixed(2);
                            showChartTooltip(item.pageX, item.pageY, item.datapoint[0], item.datapoint[1] + ' servis');
                        }
                    }
                });
        ...
        initAmChart2: function() {
            ...
            var map = AmCharts.makeChart("dashboard_amchart_2", {
                type: "map",
                "theme": "light",
                pathToImages: "~/static/global/plugins/amcharts/ammap/images/",
        ...
        initAmChart3: function() {
            ...
            var chart = AmCharts.makeChart("dashboard_amchart_3", {
                ...
                "addClassNames": true,
                "theme": "light",
                "path": "~/static/global/plugins/amcharts/ammap/images/",
                "autoMargins": false,
                "marginLeft": 30,
                "marginRight": 8,
                "marginTop": 10,
        ...
        initWorldMapStats: function() {
            ...
            $('#mapplic').mapplic({
                source: '~/static/global/plugins/mapplic/world.json',
                height: 265,
                animate: false,
                sidebar: false,
                minimap: false,
...
if (App.isAngularJsApp() === false) {
    jQuery(document).ready(function() {
        Dashboard.init(); // init static core componets
    });
}